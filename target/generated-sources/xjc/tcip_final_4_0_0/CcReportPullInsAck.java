 ...
 *         &lt;element name="ack-employee" type="{http://www.TCIP-Final-4-0-0}CPTEmployeeIden"/&gt;
 *         &lt;element name="ack-time" type="{http://www.TCIP-Final-4-0-0}CPT-DateTime"/&gt;
 *       &lt;/sequence&gt;
...
public class CcReportPullInsAck {
    ...
    @XmlElement(name = "ack-time", required = true, type = String.class)
    @XmlJavaTypeAdapter(tcip_final_4_0_0.Adapter1 .class)
    @XmlSchemaType(name = "anySimpleType")
    protected org.joda.time.DateTime ackTime;
     ...
     *     
     */
    public org.joda.time.DateTime getAckTime() {
        return ackTime;
    }
     ...
     *     
     */
    public void setAckTime(org.joda.time.DateTime value) {
        this.ackTime = value;
    }

 ...
 *         &lt;element name="effective-datetime" type="{http://www.TCIP-Final-4-0-0}CPT-DateTime" minOccurs="0"/&gt;
 *         &lt;element name="updates-since" type="{http://www.TCIP-Final-4-0-0}CPT-DateTime" minOccurs="0"/&gt;
 *         &lt;element name="updated-datetime" type="{http://www.TCIP-Final-4-0-0}CPT-DateTime"/&gt;
...
public class CPTLoadFileHeader {
    ...
    @XmlElement(name = "effective-datetime", type = String.class)
    ...
    @XmlElement(name = "updated-datetime", required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter1 .class)
    @XmlSchemaType(name = "anySimpleType")

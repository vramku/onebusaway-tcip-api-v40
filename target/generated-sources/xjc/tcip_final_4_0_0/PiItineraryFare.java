 ...
 *                   &lt;element name="itinerarie" type="{http://www.atis-partial-03-00-74}Route"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class PiItineraryFare {
    ...
    public static class Itineraries {
        ...
        @XmlElement(required = true)
        protected List<Route> itinerarie;

        /**
         * Gets the value of the itinerarie property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the itinerarie property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getItinerarie().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<Route> getItinerarie() {
            if (itinerarie == null) {
                itinerarie = new ArrayList<Route>();
            }
            return this.itinerarie;
        }

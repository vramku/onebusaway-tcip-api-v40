 ...
 *         &lt;element name="announcementText" type="{http://www.TCIP-Final-4-0-0}OB-TextMessage" minOccurs="0"/&gt;
 *         &lt;element name="announcementTextLangs" type="{http://www.TCIP-Final-4-0-0}CPTAdditionalLanguageContents" minOccurs="0"/&gt;
 *         &lt;element name="text-color" type="{http://www.TCIP-Final-4-0-0}PI-PIDTextColor" minOccurs="0"/&gt;
 *         &lt;element name="text-attributes" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence maxOccurs="5"&gt;
 *                   &lt;element name="text-attribute" type="{http://www.TCIP-Final-4-0-0}PI-PIDTextAttribute"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="announcementGraphic" type="{http://www.TCIP-Final-4-0-0}PI-BinaryImageData" minOccurs="0"/&gt;
 *         &lt;element name="announcementAudio" type="{http://www.TCIP-Final-4-0-0}PI-BinaryAudioData" minOccurs="0"/&gt;
 *         &lt;element name="graphicFormat" type="{http://www.TCIP-Final-4-0-0}PI-GraphicFormat" minOccurs="0"/&gt;
 *         &lt;element name="audioFormat" type="{http://www.TCIP-Final-4-0-0}PI-AudioFormat" minOccurs="0"/&gt;
 *         &lt;element name="audio-inside" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="audio-outside" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="text-passenger-displays" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="text-destination-signs" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="graphic-passenger-displays" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="graphic-destination-signs" type="{http://www.TCIP-Final-4-0-0}CPT-Boolean"/&gt;
 *         &lt;element name="tts-audio-text" type="{http://www.TCIP-Final-4-0-0}PI-DMSMessage" minOccurs="0"/&gt;
 *         &lt;element name="tts-audio-textLangs" type="{http://www.TCIP-Final-4-0-0}CPTAdditionalLanguageContents" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;

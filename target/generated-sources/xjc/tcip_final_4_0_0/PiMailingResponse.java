 ...
 *         &lt;element name="confirmationNum" type="{http://www.TCIP-Final-4-0-0}PI-MailingConfirmNum"/&gt;
 *         &lt;element name="reason" type="{http://www.TCIP-Final-4-0-0}PI-ReasonNotSent" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class PiMailingResponse {
    ...
    @XmlElement(required = true)
    @XmlSchemaType(name = "unsignedLong")
    protected BigInteger confirmationNum;
     ...
     *     
     */
    public BigInteger getConfirmationNum() {
     ...
     *     
     */
    public void setConfirmationNum(BigInteger value) {
